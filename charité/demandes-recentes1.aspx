<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demandes-recentes1.aspx.cs" Inherits="charité.demandes_recentes1" %>
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>Demandes d'aide</span> récentes</h1>
                    <ol class="breadcrumb">
                        <li><a href="index1.aspx">Accueil</a></li>
                        <li class="active">Demandes d'aide récentes</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
