<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demande-coll.aspx.cs" Inherits="charité.demande_coll" %>
...
<head>
    ...
    <!-- Page Title -->
    <title>Demandes des collaborateurs</title>
    <!-- style sheets-->
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>Demandes</span> des collaborateurs</h1>
                    <ol class="breadcrumb">
                        <li><a href="index1.aspx">Accueil</a></li>
                        <li class="active">Demandes des collaborateurs</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
        ...
        <section class="latest-causes section-padding">
            <div class="container">
                <div class="row content">
                      ...
                      <asp:Label ID="lbl_dmd" runat="server" Text=""></asp:Label>
