<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="creerOffre.aspx.cs" Inherits="charité.creerOffre" %>
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>Créer</span> offre</h1>
                    <ol class="breadcrumb">
                        <li><a href="index1.aspx">Accueil</a></li>
                        <li class="active">Créer une offre</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
