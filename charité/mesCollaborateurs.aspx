<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mesCollaborateurs.aspx.cs" Inherits="charité.mesCollaborateurs" %>
        ...
        <section class="latest-causes section-padding">
            <div class="container">
                <div class="row content">
                      ...
                      <asp:Label ID="lbl_coll" runat="server" Text=""></asp:Label>
