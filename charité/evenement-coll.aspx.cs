...
namespace charité
{
    public partial class evenement_coll : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < global.MesCollaborateurs.Rows.Count; i++)
            {
                ...
                if (lire.Read() != false) {
                    lbl_evt.Text += "<div class='col-lg-12'></div>";
                    lbl_evt.Text += "<div class='col-lg-12'><h3>Les evenements Creés par : <a href=\"profilVue.aspx?userID=" + utili + "\">" + prenom  + " " + nom + "</a><h3/><hr/></div>"; 
