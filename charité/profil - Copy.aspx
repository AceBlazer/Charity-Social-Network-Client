    ...
    <div class="page-wrapper volunteer-single">
        ...
        <!-- end gallery-3col-content -->
                    ...
                    <div class="col col-md-8">
                       ...
                       <div class="causes-list-box-wrapper" style="background-color: #FFFFFF" >
                           <div class="causes-list-box" >
                                <div class="img-holder">
                                    <img src="images/causes-list-box/img-1.jpg" alt class="img img-responsive">
                                     ...
                                     <div class="event-box" >
                                 <h4>  Convoi à <span class="location"><i class="fa fa-map-marker"></i> Kef</span>  </h4>  
                                         <div>
                                         <img src="images/like.png" height="30" />  <a href="#"> 34 Personnent l'aiment </a>  </div>
                                         </div>   
                                    <div class="details">                      
                                    <h3>Offrir de l'eau frais pour les enfants</h3>
                                    <div class="progress">
                                        <div class="progress-bar" data-percent="75"></div>
                                    </div>
                                    <h4>Collectés: <span>52,872</span> / 70,000 bouteilles</h4>
                                    <p>Vous êtes bienvenues pour nous aider à collecter des bouteilles d'eau pour les enfants du kef.
                                         <a href="#" class="btn theme-btn">Nous rejoindre</a>
                                    </p>
                                   
                                </div>
                                <div class="share">
                                <span style="margin-left: 10px; margin-right: 10px"> Partager: </span>
                                <ul>
                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                            ...
                            <div class="product-details" style="margin: 50px 20px 20px 20px; padding: 10px; background-color: #333333; color: #FFFFFF">
                                <section>   
            	                    <img  src="images/users/user-1.jpg"  class="img-circle" height="40" width="40" />
                                    <g> Kamille Leddington </g>
                                    <div> <p> c'était une experience géniale! merci à tous </p></div>
                                     <img src="images/like.png" height="20" width="20" style="margin-left: 10px; margin-right: 10px;" class="img-circle"/>  <a href="#"> 2 </a>
                                    <div>
                                    Répondre <input type="text" size="50" style="margin: 10px 10px 10px 25px; color: #000000" />
                                    <input type="button" class="btn theme-btn" value="Commenter" />
                                    </div>
                                 ...
                                 <section>    
                                    ...
                                    <g> Sarah Cruis </g>
                                     <div>
                                    Commenter <input type="text" size="50" style="margin: 10px; color: #000000;" />
                                    <input type="button" class="btn theme-btn" value="Commenter" />
                                    </div>
                                    <hr style="color: #FFFFFF; font-size: 2px" />   
                                </section>  
