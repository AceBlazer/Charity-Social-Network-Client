<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="evenement-coll.aspx.cs" Inherits="charité.evenement_coll" %>
...
<head>
    ...
    <!-- Page Title -->
    <title>Evènements des collaborateurs</title>
    <!-- style sheets-->
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>Evènements</span> des collaborateurs</h1>
                    <ol class="breadcrumb">
                        <li><a href="#">Accueil</a></li>
                        <li class="active">Evènements des collaborateurs</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
