<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="creerDemande.aspx.cs" Inherits="charité.creerDemande" %>
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>Créer</span>demande</h1>
                    <ol class="breadcrumb">
                        <li><a href="index1.aspx">Accueil</a></li>
                        <li class="active">Créer une demande</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
        ...
        <div class="col-lg-10" style="padding: 20px; background-color:#FFFFFF; margin: 10px;">
                  <center>  <h2>Créer</h2>  </center>
                        <hr />
                         ...
                         <fieldset>
                            ...
                            <div class="col-lg-3">
                              <br />
                                <asp:TextBox ID="categ" runat="server"></asp:TextBox>
                            </div>
            ...
            <fieldset>
                            ...
                            <div class="col-lg-5">
                             Date   <asp:TextBox ID="lbl_dd" class="form-control" TextMode="Date" runat="server" ></asp:TextBox>
                            </div>
                            ...
                            <div class="col-lg-3">
                                 <br />
                                <asp:TextBox ID="lbl_vali" placeholder="Valeur des dons"  class="form-control" runat="server"></asp:TextBox>
                            </div>
