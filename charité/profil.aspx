<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profil.aspx.cs" Inherits="charité.profil" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="page-wrapper volunteer-single">
                    ...
                    <div id="navbar" class="navbar-collapse collapse navbar-left">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul>
                                    <li><a href="demandes-recentes1.aspx">Demandes récentes</a></li>
                                    <li><a href="demande-coll.aspx">Demandes des collaborateurs</a></li>
                                </ul>
                            </li>
                            <li class="sub-menu">
                                <a href="#">Mes Pages</a>
                                <ul>
                                    <li><a href="profil.aspx">Mon Profil</a></li>
                                    <li><a href="MesCollaborateurs.aspx">Mes Collaborateurs</a></li>
                                    <li><a href="calend.aspx">Mon Agenda</a></li>
                                    <li><a href="MesEvenements.aspx">Mes évènements</a></li>
                                    <li><a href="mesOffres.aspx">Mes offres</a></li>
                                    <li><a href="mesDemandes.aspx">Mes demandes</a></li>
                                </ul>
                            </li>
                            <li class="sub-menu">
                                <a href="#">évènements</a>
                                <ul>
                                    ...
                                    <li><a href="evenement-proximite.aspx">évènements à proximité</a></li>
                                    <li><a href="evenement-coll.aspx">évènements des collaborateurs</a></li>
                                </ul>
                            </li>
                                
                               <li> <a href="offres-recents.aspx">offres récentes</a></li>
                            <li>
                            ...
                            <div>
                                ...
                                <p><span><asp:Label ID="lbl_fonction" runat="server" Text="-"></asp:Label></span></p>
                                 <div class="rating">
                                    ...
                                    <asp:Label ID="lbl_etoiles" runat="server" Text="-"></asp:Label>
                            </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="info">
                            ...
                            <ul class="info-details">
                                ...
                                <li>
                                    ...
                                    <asp:Label ID="lbl_organisation" runat="server" Text="-"></asp:Label>
                                </li>
                                <li>
                                    <span>Contribution</span>
                                    <asp:Label ID="lbl_cnt_demandes" runat="server" Text="-"></asp:Label> demandes, <asp:Label ID="lbl_cont_offres" runat="server" Text="-"></asp:Label> offres, <asp:Label ID="lbl_cont_evenements" runat="server" Text="-"></asp:Label> évènements
                                </li>
                                <li>
        ...
        <!-- end gallery-3col-content -->
                    ...
                    <div class="col col-md-8">
                         <div> <center><h4>Publications qui me concernent </center></h4> </div>
        ...
        <!-- popup -->
          <div id="abc" style="z-index:100;">
            ...
            <div id="popupContact" class="center img-rounded img-responsive"  style="padding: 10px; border: 5px solid #808080; background-color:#FFFFFF; z-index:999; left: 50%;  top:20%;  position: center;height:auto;width:auto; background-repeat: no-repeat; ">
                <!-- Contact Us Form -->
                
                    <img id="close" src="images/3.png" width="30" height="30" class="img-circle" style="z-index: 999;">
                    
                  <h4><center> Quelle publication voulez vous créer? </center></h4>
                  <center>
                      <asp:Button ID="stat" class="bnt theme-btn" runat="server" Text="statut" OnClick="redirstatut" />
                       <asp:Button ID="evt" class="bnt theme-btn" runat="server" Text="évènement" OnClick="redirevt" />
                      <asp:Button ID="dmd" class="bnt theme-btn" runat="server" Text="demande" OnClick="redirdmd" />
                      <asp:Button ID="offre" class="bnt theme-btn" runat="server" Text="offre" OnClick="rediroffre" />
                  </center>
