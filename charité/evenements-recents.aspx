<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="evenements-recents.aspx.cs" Inherits="charité.evenements_recents" %>
...
<head>
    ...
    <!-- Page Title -->
    <title>Evènementss Récents</title>
    <!-- style sheets-->
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>Evènements</span> récents</h1>
                    <ol class="breadcrumb">
                        <li><a href="#">Accueil</a></li>
                        <li class="active">Evènements récents</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
        ...
        <section class="latest-causes section-padding">
            <div class="container">
                <div class="row content">
                      ...
                      <asp:Label ID="lbl_evt" runat="server" Text=""></asp:Label>
                            ...
                            <div class="urgent-box">
                                ...
                                <div class="details">
                                    ...
                                    <div class="goal-raised">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" placeholder="- Entrer la valeur -" >
                                        </div>
                                        <div>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-7 subscribe">
                        ...
                        <p>Pour plus de<span> nouvelles</span> et avoir un espace persnnel pour <span>créer des évènements</span> et les partager avec vos<span> collaborateurs</span></p>
                            ...
                            <div>
                                <input class="form-control" type="email" placeholder="addresse email">
