<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demande-proximite.aspx.cs" Inherits="charité.demande_proximite" Async="true" %>
...
<head>
    ...
    <!-- Page Title -->
    <title>Demandes à proximité</title>
    <!-- style sheets-->
...
<body id="body" onclick="check(event)">
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <section class="page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1><span>demandes d'aide</span> à proximité</h1>
                    <ol class="breadcrumb">
                        <li><a href="index1.aspx">Accueil</a></li>
                        <li class="active">demandes à proximité</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
