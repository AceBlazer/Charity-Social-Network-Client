<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notifrealtime.aspx.cs" Inherits="charité.notifrealtime" %>
    ...
    <div class="page-wrapper causes-grid-page">
        ...
        <div class="col-lg-10" style="padding: 20px; background-color:#FFFFFF; margin: 10px;">
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    <h3><span>
                        <asp:Label ID="lbl_nbnotif" runat="server" Text=""></asp:Label></span> Nouvelles notifications </h3>
                     <center> <a href="notification.aspx">Voir tout</a> </center>
                </ContentTemplate>
            </asp:UpdatePanel>
