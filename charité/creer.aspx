<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="creer.aspx.cs" Inherits="charité.WebForm1" %>
        ...
        <div class="col-lg-10" style="padding: 20px; background-color:#FFFFFF; margin: 10px;">
                  <center>  <h2>Créer</h2>  </center>
                        <hr />
                         ...
                         <fieldset>
                             <legend style="color: #FF9900">Type</legend>
                            
                             <div class="col-lg-3">
                                 Type évènement
                                 <br />
                                 <asp:DropDownList ID="lst_type_ev" runat="server">
                                    <asp:ListItem Selected="True" >Educatif</asp:ListItem>
                                    <asp:ListItem>Concert</asp:ListItem>
                                    <asp:ListItem>Fête</asp:ListItem>
                                    <asp:ListItem>Collection</asp:ListItem>
                                    <asp:ListItem>Campagne</asp:ListItem>
                                    <asp:ListItem>Visite</asp:ListItem>
                                    <asp:ListItem>Défi</asp:ListItem>
                                </asp:DropDownList>
                                 </div>
                            <div class="col-lg-3">
                              <br />
                                <asp:TextBox ID="lbl_titre" placeholder="Titre" class="form-control" runat="server" ></asp:TextBox>
                            </div>                           
                             </fieldset>
                            
                                <br />
                            <fieldset>
                                 <legend style="color: #FF9900">Dates et Lieux </legend>
                            
                            <br />
                                <!--
                               <asp:TextBox ID="lbl_vd" placeholder="Ville de départ" class="form-control"  runat="server" ></asp:TextBox>
                            </div>
                            <div class="col-lg-3">
                                <br />
                               <asp:TextBox ID="lbl_va" placeholder="Ville d'arrivée" class="form-control"  runat="server" ></asp:TextBox>
                           -->
            ...
            <fieldset>
                            ...
                            <div class="col-lg-5">
                             De   <asp:TextBox ID="lbl_dd" class="form-control" TextMode="Date" runat="server" ></asp:TextBox>
                            </div>
                            <div class="col-lg-5">
                              à  <asp:TextBox ID="lbl_df"  class="form-control" TextMode="Date" runat="server" ></asp:TextBox>
                            </div>

                            <div class="col-lg-10"></div>
                            <div class="col-lg-5">
                            <asp:TextBox ID="lbl_td" class="form-control" TextMode="Time" runat="server" ></asp:TextBox>
                            </div>
                            <div class="col-lg-5">
                            <asp:TextBox ID="lbl_tf"  class="form-control" TextMode="Time" runat="server" ></asp:TextBox>
                            </div>
                            ...
                            <div class="col-lg-5">
                                <br />
                                <asp:TextBox ID="lbl_desc" placeholder="Description" class="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-lg-5">
                                ...
                                Types des dons 
                                    <br />
                                <asp:DropDownList ID="lst_type_dons" runat="server">
                            ...
                            <div class="col-lg-3">
                                 <br />
                                <asp:TextBox ID="lbl_vali" placeholder="Valeur initiale des dons"  class="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-lg-3">
                                <br />
                                <asp:TextBox ID="lbl_vala" placeholder="Valeur attendue des dons "  class="form-control" runat="server"></asp:TextBox>
                            </div>
                             </fieldset>   
                                    <hr />
                                    <center>
